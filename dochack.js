...
function chckIndx(i_p0, a_p1, b_p2) {
  var result_33557387 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557387 = i_p0;
    break BeforeRet;
    }
    else {
...
function chckRange(i_p0, a_p1, b_p2) {
  var result_33557392 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557392 = i_p0;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function add__system_u1967(x_p0, x_p0_Idx, y_p1) {
...
function isNimException__system_u2038() {
...
function getCurrentException() {
  var result_33556473 = null;

    if (isNimException__system_u2038()) {
    result_33556473 = lastJSError;
    }
    

  return result_33556473;
...
function raiseDefect() {
    ...
    if (isObj(e_33556686.m_type, NTI33555175)) {
    if ((excHandler == 0)) {
...
function unhandledException(e_p0) {
    ...
    nimAddStrStr(buf_33556680[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110,58,32]);;
    nimAddStrStr(buf_33556680[0], e_p0.message);;
    }
    else {
    nimAddStrStr(buf_33556680[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110]);;
    }
    
    nimAddStrStr(buf_33556680[0], [32,91]);;
    add__system_u1967(buf_33556680, 0, e_p0.name);
    nimAddStrStr(buf_33556680[0], [93,10]);;
